...
export const APP_NAVIGATION: AppMenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Reimbursements", icon: "receipt", children: [{ label: "Expense Claims", link: all_routes.expenseClaims, allowedRoles: ALL_PEOPLE_ROLES }, { label: "Claims Approval", link: all_routes.expenseApprovals, allowedRoles: ALL_ADMIN_ROLES }] },
    ],
  },
  {
    title: "Recruitment",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "E-Sign", icon: "signature", allowedRoles: ["super_admin", "hr", "employee"], children: [{ label: "E-Sign Desk", link: all_routes.eSignDesk, allowedRoles: ["super_admin", "hr"] }, { label: "My Signatures", link: all_routes.eSignWorkspace, allowedRoles: ["super_admin", "hr", "employee"] }] },
