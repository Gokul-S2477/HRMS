...
export const APP_NAVIGATION: AppMenuSection[] = [
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "My Workspace", icon: "user-circle", link: all_routes.myWorkspace, allowedRoles: ["super_admin", "hr", "employee"] },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Notice Board", icon: "bell-ringing", link: all_routes.announcements, allowedRoles: ALL_PEOPLE_ROLES },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Leave", icon: "calendar-off", children: [{ label: "Leave Inbox", icon: "inbox", link: all_routes.leaveadmin, allowedRoles: STAKEHOLDER_FACING }, { label: "My Leave", icon: "calendar-user", link: all_routes.leaveemployee, allowedRoles: ALL_PEOPLE_ROLES }, { label: "Leave Types", icon: "calendar-event", link: all_routes.leaveType, allowedRoles: ALL_ADMIN_ROLES }, { label: "Leave Policy Engine", icon: "adjustments-horizontal", link: all_routes.leavesettings, allowedRoles: ALL_ADMIN_ROLES }] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Payroll", icon: "cash-banknote", children: [{ label: "Salary Components", icon: "adjustments", link: all_routes.salaryComponents, allowedRoles: ALL_ADMIN_ROLES }, { label: "Employee Salary", icon: "users", link: all_routes.employeePayroll, allowedRoles: ALL_ADMIN_ROLES }, { label: "Payslips", icon: "file-description", link: all_routes.payslips, allowedRoles: ALL_PEOPLE_ROLES }, { label: "Loans & Advances", icon: "cash", link: all_routes.employeeLoans, allowedRoles: ALL_PEOPLE_ROLES }, { label: "Statutory Reports", icon: "file-analytics", link: all_routes.statutoryReports, allowedRoles: ALL_PEOPLE_ROLES }, { label: "Payroll Items", icon: "list-numbers", link: all_routes.payrollItems, allowedRoles: ALL_ADMIN_ROLES }, { label: "Final Settlements", icon: "signature", link: all_routes.finalSettlements, allowedRoles: ALL_ADMIN_ROLES }] },
