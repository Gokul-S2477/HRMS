...
export const all_routes = {
  ...
  refferal: "/refferals",
  recruitmentInterviews: "/recruitment/interviews",
  careersJobs: "/careers/jobs",
  careersJobDetails: "/careers/jobs/:jobId/:jobSlug",
  careersJobDetailsSimple: "/careers/jobs/:jobId",
  careersApply: "/careers/jobs/:jobId/:jobSlug/apply",
  careersApplySimple: "/careers/jobs/:jobId/apply",
  applicantAccess: "/careers/access",
  applicantDashboard: "/careers/dashboard",
  ...
  taxes: "/sales/taxes",
  salesInvoiceDetails: "/sales/invoices/view/:id",
  ...
  employeeDetailsView: "/employee-details/:id",
  ...
  finalSettlements: "/accounts/final-settlements",
